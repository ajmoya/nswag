...
namespace API_3.1_Repo
{
    using System = global::System;
    
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.4.2.0 (NJsonSchema v10.1.11.0 (Newtonsoft.Json v12.0.0.0))")]
    public partial class OtroLimitadoClient 
    {
        private string _baseUrl = "";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public OtroLimitadoClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl; 
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ModeloOtroLimitado>> GetAsync()
        {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ModeloOtroLimitado>> GetAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/OtroLimitado");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<ModeloOtroLimitado>>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(System.Collections.Generic.ICollection<ModeloOtroLimitado>);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    public partial class ModeloOtroLimitado 
    {
